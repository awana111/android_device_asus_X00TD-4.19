...
git clone --depth=1 https://github.com/awana111/android_device_asus_sdm660-common-4.19 -b Axion device/asus/sdm660-common
...
git clone --depth=1 --recursive https://github.com/awana111/android_kernel_asus_sdm660 -b main kernel/asus/sdm660
